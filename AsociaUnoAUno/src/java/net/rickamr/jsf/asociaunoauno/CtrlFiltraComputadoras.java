...
import net.rickamr.biblioteca.jsf.CtrlFiltro;
...
@Named(value = "ctrlFiltraComputadoras") @RequestScoped
public class CtrlFiltraComputadoras extends CtrlFiltro<Computadora> {
  @Override
  protected String getConsulta() {
    return Computadora.FILTRO;
  }
}
